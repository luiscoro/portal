(function ($) {
  ...
  $(".single-player-slider").on("translate.owl.carousel", function () {
    $(".single-player-details-area .thumb img")
  ...
  $(document).on("click touchstart", function (e) {
    if (
      !$(e.target).is(
        ".header-cart-menu-btn, .header-cart-menu-btn *, .shopping-cart-dropdown, .shopping-cart-dropdown *"
      )
    ) {
      $(".shopping-cart-dropdown").removeClass("open-drp");
  ...
  jQuery(
    '<div class="quantity-nav"><div class="quantity-button quantity-up"><i class="fa fa-chevron-up"></i></div><div class="quantity-button quantity-down"><i class="fa fa-chevron-down"></i></div></div>'
